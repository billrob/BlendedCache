...
namespace BlendedCache.Framework.IntegrationTests.SimpleGetSetTests
{
	...
	/// ensure the right data item is being returned.
	/// </summary>
	[TestFixture]
	public class SimpleGetAllVariations_ReturnTypeOnlyTests
	{
		...
		[Test]
		public void when_in_VolatileCache_should_return_Volatile()
		{
		...
		[Test]
		public void when_in_LongTermCache_should_return_LongTermItem()
		{
			Execute(longTermCache: _longTermCache_Full);

			Assert.NotNull(_response);
			Assert.AreEqual(_longTermCachedItem, _response);
		}
				
		[Test]
		public void when_in_LongTermCache_and_VolatileCache_should_return_VolatileItem()
		{
